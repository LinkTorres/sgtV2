...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Entorno Admin-CATT</title>
				...
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>
							...
							Sistema de Gesión de la Titulación
						</small>
					</a>
				</div>
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="GestionarProfesores.html">
							
							<i class="menu-icon fa fa-users"></i>
							<span class="menu-text"> Gestionar Profesores </span>
						</a>
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="Protestas.html" >
									<i class="menu-icon fa fa-caret-right"></i>
									Protestas
								</a>
							</li>
							<li class="">
								<a href="AsignarProtestas.html">
									<i class="menu-icon fa fa-caret-right"></i>
									Asignar Fechas de Protesta
								</a>
						</ul>
					...
					<li class="">
						<a href="Actas.html">
							...
							<span class="menu-text"><small>Actas de Exámen P.</small> </span>
						</a>
					...
					<li class="">
						<a href="Estadisticas.html">
							...
							<span class="menu-text"> Generar Estadísticas </span>
						</a>

						<b class="arrow"></b>
					</li>
	
				</ul><!-- TERMINA LA BARRA DE MENÚS -->
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
											...
											<div class="widget-body">
												...
												<form class="form-horizontal" role="form">
														<div class="form-group">
															...
															<div class="col-sm-9">
															{{ Form::text('numerott', '', array('placeholder' => 'Ej. 2014-A038', 'class'=> 'col-xs-10 col-sm-5')); }}
															</div>
														</div>
													...
													<h3>Información de los Pasantes</h3>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<span class="input-icon">
																	{{ Form::text('pasante1', '', array('placeholder' => 'Boleta')); }}
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<span class="input-icon">
																	{{ Form::text('pasante2', '', array('placeholder' => 'Boleta')); }}
																	<i class="ace-icon fa fa-leaf blue"></i>
																</span>													
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<span class="input-icon">
																	{{ Form::text('pasante3', '', array('placeholder' => 'Boleta')); }}
																	<i class="ace-icon fa fa-leaf blue"></i>
																</span>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<span class="input-icon">
																	{{ Form::text('pasante4', '', array('placeholder' => 'Boleta')); }}
																	<i class="ace-icon fa fa-leaf blue"></i>
																</span>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<span class="input-icon">
																	{{ Form::text('pasante5', '', array('placeholder' => 'Boleta')); }}
																	<i class="ace-icon fa fa-leaf blue"></i>
																</span>
															</div>
														</div>
													...
													<h3>Información del jurado</h3>
														<div class="form-group">
															...
															{{ Form::select('director1', array('Profesor1' => 'Profesor1', 'Profesor2' => 'Profesor2', 'etc' => 'etc'), array('class' => 'col-xs-10 col-sm-5')); }}													
														</div>			
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-8">Director 2  </label>
															{{ Form::select('director2', array('Profesor1' => 'Profesor1', 'Profesor2' => 'Profesor2', 'etc' => 'etc'), array('class' => 'col-xs-10 col-sm-5')); }}	
															
														</div>	
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-8">Sinodal 1  </label>
															{{ Form::select('sinodal1', array('Profesor1' => 'Profesor1', 'Profesor2' => 'Profesor2', 'etc' => 'etc'), array('class' => 'col-xs-10 col-sm-5')); }}
															<label> 
														...
														<div class="form-group">
															...
															{{ Form::select('sinodal2', array('Profesor1' => 'Profesor1', 'Profesor2' => 'Profesor2', 'etc' => 'etc'), array('class' => 'col-xs-10 col-sm-5')); }}
															<label> 
														<input name="switch-field-1" class="ace ace-switch ace-switch-6" type="checkbox" />
														<span class="lbl"></span>Asistencia
														</label>
														...
														<div class="form-group">
															...
															{{ Form::select('sinodal3', array('Profesor1' => 'Profesor1', 'Profesor2' => 'Profesor2', 'etc' => 'etc'), array('class' => 'col-xs-10 col-sm-5')); }}
															<input name="switch-field-1" class="ace ace-switch ace-switch-6" type="checkbox" />
															<span class="lbl"></span>Asistencia
															</label>
														</div>				
						...
						</div><!--FIN del Contenido de la pagina -->
				</div>
			</div><!-- /.main-content -->
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">SGT</span>
