						...
						<div class="row">
								...
								<div class="row">
									<div class="widget-box transparent">
                                            ...
                                            @endif
													{{ Form::open(array('url' => '/gestionProfesores', 'class' => 'form-horizontal')); }}
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Cédula </label>

															<div class="col-sm-9">
																{{ Form::text('cedula', '', array('class' => 'col-xs-10 col-sm-5','placeholder' => 'Cédula')); }}
														...
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-8">Nombre</label>
															...
															<div class="col-sm-9">
																...
																<span class="input-icon input-icon-right">
																	{{ Form::text('ap', '', array('placeholder' => 'Apellido Paterno')); }}<i class="ace-icon fa fa-leaf green"></i>
																</span>
																<span class="input-icon input-icon-right">
																	{{ Form::text('am', '', array('placeholder' => 'Apellido Materno')); }}<i class="ace-icon fa fa-leaf green"></i>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																	{{ Form::select('genero', array('M' => 'Masculino', 'F' => 'Femenino'), array('class' => 'col-xs-3 col-sm-3')); }}
																
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-3"> Cargo </label>

															<div class="col-sm-9">
																
																{{ Form::select('cargo', array('Otro' => 'Otro', 'Director' => 'Director', 'Subdirector' => 'Subdirector'), array('class' => 'col-xs-10 col-sm-5')); }}
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																{{ Form::text('mail', '', array('placeholder' => 'E-mail', 'class' => 'col-xs-10 col-sm-5')); }}
